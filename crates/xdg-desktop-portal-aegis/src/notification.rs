...
//! `aegis-portal-prompter --notification-daemon`, which speaks the
//! newline-delimited stream protocol in `aegis_portal_prompter::notify`
...
fn spawn_daemon(
    ...
    let pump = std::thread::Builder::new()
        .name("aegis-portal-notify-pump".to_owned())
