...
pub(crate) struct Transport {
    ...
    pub(crate) target: aegis_portal_ipc::StreamTarget,
    /// The cursor mode the live stream was started with; restarts reuse it.
    pub(crate) cursor: aegis_portal_ipc::StreamCursorMode,
...
impl Transport {
    pub(crate) fn new(
        started: aegis_portal_ipc::StreamStarted,
        target: aegis_portal_ipc::StreamTarget,
